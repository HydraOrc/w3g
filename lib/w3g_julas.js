...
(function() {
  var ACTION_DELAY, MAX_DATABLOCK, RETRAINING_TIME, Replay, action, color, convert, exit, fs, inflate, observer, php, speed, unpack, visibility;
  ...
  module.exports = Replay = (function() {
    ...
    Replay.prototype.loadplayer = function() {
      ...
      for (key in action) {
        act = action[key];
        this.players[player_id].actions_details[act] = 0;
      }
      i = 0;
    ...
    Replay.prototype.loadgame = function() {
      ...
      this.game.observers = observer[((php.ord(temp[1]) & 16) === true) + 2 * ((php.ord(temp[1]) & 32) === true)];
      ...
      if (php.ord(temp[3]) & 64) {
        this.game.observers = observer[4];
      }
      ...
      while (data_left > this.max_datablock) {
        ...
        switch (block_id) {
          ...
          case 0:
            ...
            break;
          default:
            return exit('Unhandled replay command block at ' + convert.time(this.time) + ': 0x' + sprintf('%02X', block_id) + ' (prev: 0x' + sprintf('%02X', prev) + ', time: ' + this.time + ') in ' + this.filename);
        }
      }
    };

    Replay.prototype.parseactions = function(actionblock, data_length) {
      var ability, block_length, hero, i, itemid, n, name, player_id, prev, race_detected, retraining_time, temp, value, was_deselect, was_subgroup, was_subupdate, _ref, _results;
      block_length = 0;
      action = 0;
      _results = [];
      while (data_length) {
        ...
        while (n < block_length) {
          ...
          switch (action) {
            case 0x10:
              ...
              if (!value) {
                this.players[player_id].actions_details[action.ability]++;
                ...
                this.players[player_id].actions_details[action.buildtrain]++;
            ...
            case 0x11:
              ...
              if (php.ord(actionblock[n + 2]) <= 0x19 && php.ord(actionblock[n + 3]) === 0x00) {
                this.players[player_id].actions_details[action.basic]++;
              } else {
                this.players[player_id].actions_details[action.ability]++;
              }
            ...
            case 0x12:
              ...
              if (php.ord(actionblock[n + 2]) === 0x03 && php.ord(actionblock[n + 3]) === 0x00) {
                this.players[player_id].actions_details[action.rightclick]++;
            ...
            case 0x13:
              ...
              this.players[player_id].actions_details[action.item]++;
              if (this.header.major_v >= 7) {
                n += 38;
              } else {
                n += 30;
            ...
            case 0x16:
              ...
              if (temp.mode === 0x02 || !was_deselect) {
                this.players[player_id].actions++;
                this.players[player_id].actions_details[action.select]++;
              }
            ...
            case 0x17:
              this.players[player_id].actions++;
              this.players[player_id].actions_details[action.assignhotkey]++;
            ...
            case 0x18:
              this.players[player_id].actions++;
              this.players[player_id].actions_details[action.selecthotkey]++;
            ...
            case 0x19:
              if (this.header.build_v >= 6040 || this.header.major_v > 14) {
                if (was_subgroup) {
                  this.players[player_id].actions++;
                  this.players[player_id].actions_details[action.subgroup]++;
            ...
            case 0x1E:
              if ((this.header.build_v >= 6040 || this.header.major_v > 14) && action !== 0x1E) {
                ...
                this.players[player_id].actions++;
                this.players[player_id].actions_details[action.removeunit]++;
            ...
            case 0x61:
              this.players[player_id].actions++;
              this.players[player_id].actions_details[action.esc]++;
              ++n;
              break;
            case 0x62:
              if (this.header.major_v >= 7) {
            ...
            case 0x65:
              this.players[player_id].actions++;
              this.players[player_id].actions_details[action.heromenu]++;
              ++n;
              break;
            case 0x66:
              this.players[player_id].actions++;
              if (this.header.major_v >= 7) {
                ...
                this.players[player_id].actions_details[action.buildmenu]++;
              }
              n += 1;
              break;
            case 0x67:
            ...
            default:
              ...
              this.errors.push('Unknown action at ' + convert.time(this.time) + ': 0x' + sprintf('%02X', action) + ', prev: 0x' + sprintf('%02X', prev) + ', dump: ' + temp);
              continue3;
          }
        }
